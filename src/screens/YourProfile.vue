...
<style scoped>
    .heading {
        background: #391BCF;
        background: -webkit-linear-gradient(to right, #391BCF 0%, #CF2EA4 77%);
        background: -moz-linear-gradient(to right, #391BCF 0%, #CF2EA4 77%);
        background: linear-gradient(to right, #391BCF 0%, #CF2EA4 77%);
